...
class PencariKerjaRegistrasi extends StatefulWidget {
  @override
  _PencariKerjaRegistrasiState createState() => _PencariKerjaRegistrasiState();
}

class _PencariKerjaRegistrasiState extends State<PencariKerjaRegistrasi> {
  ...
  Future<void> _registrasiPencariKerja() async {
    try {
      var request = http.MultipartRequest(
          'POST', Uri.parse(Config.registrasiPencariKerjaUrl));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Registrasi Pencari Kerja'),
      ),
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10),
              ElevatedButton(
                onPressed: _registrasiPencariKerja,
