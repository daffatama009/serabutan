...
import 'package:serabutan/pemberi_kerja_pages/contents/pemberi_kerja_detail_pekerjaan_selesai.dart';
import 'dart:convert';
...
class PemberiKerjaPekerjaanSelesaiPage extends StatefulWidget {
  const PemberiKerjaPekerjaanSelesaiPage({super.key});

  @override
  State<PemberiKerjaPekerjaanSelesaiPage> createState() =>
      _PemberiKerjaPekerjaanSelesaiPageState();
}

class _PemberiKerjaPekerjaanSelesaiPageState
    extends State<PemberiKerjaPekerjaanSelesaiPage> {
  ...
  Future<void> _fetchPekerjaanSelesai() async {
    try {
      ...
      final response = await http.post(
        Uri.parse(Config.baseUrl + 'ambil_pekerjaan_selesai_pemberi_kerja.php'),
        body: {
                          ...
                          child: ListTile(
                            ...
                            onTap: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      PemberiKerjaDetailPekerjaanSelesaiPage(
                                          idPekerjaan:
